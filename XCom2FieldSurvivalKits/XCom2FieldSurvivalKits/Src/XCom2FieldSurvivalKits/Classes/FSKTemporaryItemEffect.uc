//---------------------------------------------------------------------------------------
//  ADAPTED FROM:    X2Effect_TemporaryItem
//  ORIGINAL AUTHOR:  Amineri (Pavonis Interactive)
//  ORIGINAL PURPOSE: Effect for adding temporary items to a unit
//--------------------------------------------------------------------------------------- 

class FSKTemporaryItemEffect extends X2Effect_Persistent;

`define PPTRACE(msg) `Log(`msg)
...
simulated protected function OnEffectAdded(const out EffectAppliedData ApplyEffectParameters, XComGameState_BaseObject kNewTargetState, XComGameState NewGameState, XComGameState_Effect NewEffectState)
{
	...
	local FSKTemporaryItemEffectGameState		EffectComponent;
	...
	else // Unit either doesn't have item, or it has it and it has to be replaced
	{
		...
		{
			EffectComponent = FSKTemporaryItemEffectGameState(NewGameState.CreateStateObject(class'FSKTemporaryItemEffectGameState'));
...
static function FSKTemporaryItemEffectGameState GetEffectComponent(XComGameState_Effect Effect)
{
	if (Effect != none) 
		return FSKTemporaryItemEffectGameState(Effect.FindComponentObject(class'FSKTemporaryItemEffectGameState'));
	return none;
}
...
simulated function OnEffectRemoved(const out EffectAppliedData ApplyEffectParameters, XComGameState NewGameState, bool bCleansed, XComGameState_Effect RemovedEffectState)
{
	...
	local FSKTemporaryItemEffectGameState TempItemComponent;
	...
	TempItemComponent = FSKTemporaryItemEffectGameState(EffectComponent);
